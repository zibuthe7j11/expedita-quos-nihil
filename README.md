# @zibuthe7j11/expedita-quos-nihil

[![npm version](https://img.shields.io/npm/v/@zibuthe7j11/expedita-quos-nihil.svg)](https://www.npmjs.com/package/@zibuthe7j11/expedita-quos-nihil)
[![Downloads/month](https://img.shields.io/npm/dm/@zibuthe7j11/expedita-quos-nihil.svg)](http://www.npmtrends.com/@zibuthe7j11/expedita-quos-nihil)
[![tests](https://github.com/zibuthe7j11/expedita-quos-nihil/actions/workflows/test.yml/badge.svg)](https://github.com/zibuthe7j11/expedita-quos-nihil/actions/workflows/test.yml)
...
```
npm install @zibuthe7j11/expedita-quos-nihil
```
...
```js
var cpx = require("@zibuthe7j11/expedita-quos-nihil");
```
...
[GitHub Releases](https://github.com/zibuthe7j11/expedita-quos-nihil/releases)
